...
export const projectsData: Project[] = [
  {
    ...
    todos: {
      todo: [
        ...
        { name: "Learn front-end frameworks (e.g., React)", desc: "Dive into a front-end framework like React", },
        { name: "Create a full-stack web app", desc: "", },
      ],
      inProgress: [
        { name: "Study JavaScript fundamentals", desc: "Master the basics of JavaScript for web development", },
        { name: "Study back-end development (e.g., Node.js)", desc: "", },
      ],
      completed: [
        { name: "Explore responsive web design", desc: "Learn how to make web pages work on different screen sizes", },
